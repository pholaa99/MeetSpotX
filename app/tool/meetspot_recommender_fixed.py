...
"""
    ...
    async def _generate_html_page(
        ...
        file_name = f"meetspot_recommendation_{datetime.now().strftime('%Y%m%d%H%M%S')}_{file_id}.html"
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p> 2025 MeetSpot - 最佳会面点推荐 | 数据来源: 高德地图</p>
        </div>
    </div>
